...

{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Задание 1 Ввод информации в текстовый файл");
            CreateTextFile filename = new CreateTextFile();
            //filename.Filename = "text.txt";
            filename.info();


            // Задание 2 Сегодняшнее время в файл startup.txt
            Console.WriteLine("Задание 2 Сегодняшнее время в файл startup.txt");
            DateTimeNow DateTime = new DateTimeNow();
            DateTime.info();

            // Задание 3 Ввод чисел в бинарный файл
            Console.WriteLine("Задание 3 Ввод чисел в бинарный файл");
            CreateBinaryFile BinFile = new CreateBinaryFile();
            BinFile.info();
